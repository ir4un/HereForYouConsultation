...
<head>
    ...
    <title>HYFC Past Consultation Page</title>
    <link rel="stylesheet" href="displaypast.css">
                ...
                <div class='overlay'>
                    ...
                    <div class="remainder">
                        ...
                        <div class="title-border">
                            <p> YOUR </p>
                            <h1>Past Consultation<span>Summary</span>
                            </h1>
                        </div>
                        <?php
                        if (isset($_SESSION['id'])) {
                            if (isset($_GET['id'])) {
                                $sql = "SELECT * FROM `consultor_consultation` WHERE `Consultation_ID` = " . $_GET['id'];
                                $result = mysqli_query($conn, $sql);
                                ...
                                $sql = "SELECT * FROM consultation_info WHERE ConsultationSessionID = " . $_GET['id'];
                                $result = mysqli_query($conn, $sql);
                                $row = mysqli_fetch_assoc($result);
                                $service = $row['ConsultType'];
                                $rating = $row['ConsultRating'];
                                $feedback = $row['ConsultFeedback'];
                            }
                        }
                        ?>
                        <table>
                            ...
                            <tr>
                                ...
                                <td style="color: #1d2e68;"><?php echo $service; ?></td>
                            </tr>
                            ...
                            <tr>
                                <td style="font-weight: bold;">Consultation Time:</td>
                                <td style="color: #1d2e68;"><?php echo "$starttime - $endtime"; ?></td>
                            </tr>

                            <tr>
                                <td style="font-weight: bold;">Consultation Rating:</td>
                                <td style="color: #1d2e68;"><?php echo $rating; ?></td>
                            </tr>

                            <tr>
                                <td style="font-weight: bold;">Consultation Feedback:</td>
                                <td style="color: #1d2e68;"><?php echo $feedback; ?></td>
                            </tr>
